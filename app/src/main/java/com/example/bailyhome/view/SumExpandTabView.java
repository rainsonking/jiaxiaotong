 ...
 */
public class SumExpandTabView extends LinearLayout implements PopupWindow.OnDismissListener {
    ...
    public SumExpandTabView(Context context) {
        super(context);
        init(context);
    }

    public SumExpandTabView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
