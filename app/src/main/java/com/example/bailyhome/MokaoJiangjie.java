 ...
 * 随堂作业界面
 */
public class MokaoJiangjie extends BaseActivity {
    private TextView tv_course_name, tv_kaoti_version, tv_mokao_date, tv_mokao_start_date
    ,tv_xiaoqu,tv_mokao_state,text_header,tv_order_date;
   ...
   // private ImageView menu_img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.course_detail3);
    ...
    public void initView() {
      ...
      //  tv_mokao_end_date = (TextView) findViewById(R.id.tv_mokao_end_date);
        ...
        if (map!=null){
           ...
           // tv_mokao_end_date.setText(!TextUtils.isEmpty(mokao_end_date)?mokao_end_date:"");
          //  tv_jiqi.setText(!TextUtils.isEmpty(jiqi)?jiqi:"");
            ...
            if (!TextUtils.isEmpty(peixunState)&&!peixunState.equals("已培训")){
                ...
                tv_order_date.setText("上课日期");
                layout_teach_note.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent=new Intent(MokaoJiangjie.this,TeachLogActivity.class);
